<template>
  <transition name="fade">
    <div v-if="cartStore.modalIsOpen">
      <div
        @click="onToggle"
        class="fixed top-0 left-0 right-0 bg-black opacity-70 inset-0 z-0 h-full"
      ></div>
      <div class="fixed w-full max-w-lg p-3 rounded-xl shadow-lg bg-white cart-modal">
        <div>
          <div class="text-center p-3 flex-auto justify-center leading-6">
            <h2 class="text-2xl py-4">Product added to your cart!</h2>
